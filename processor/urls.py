...
from .views import RegisterView, RegisterProcessView, LoginView, IndexView, ProvacyPolicy, TermsAndCondition
...
urlpatterns = [
    ...
    path('terms-and-conditions/', TermsAndCondition.as_view(), name='register-processor'),
    path('privacy-policy/', ProvacyPolicy.as_view(), name='register-processor'),
